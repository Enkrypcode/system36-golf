...
import { scoreEntryGrossCsv, scoreEntryGrossFilename, scoreEntryScoresCsv, scoreEntryScoresFilename } from "@/lib/score-entry-export";
...
export function ScoreEntry({ tournamentName, rounds, courses, savedScores, scoringSystem, tournamentFormat, jackpotEnabled, jackpotBlindHoles, jackpotRevealed, onScoresChange, onHandicapChange, onBack, onContinue }: Props) {
  ...
  const exportScoresCsv = () => downloadCsv(
    scoreEntryScoresCsv(players, course.pars!, { scoringSystem, tournamentFormat }),
