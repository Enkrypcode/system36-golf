...
type Props = {
  ...
  scoringSystem: ScoringSystem; tournamentFormat: TournamentFormat;
...
export function ScoreEntry({ tournamentName, rounds, courses, savedScores, scoringSystem, tournamentFormat, onScoresChange, onHandicapChange, onBack, onContinue }: Props) {
  ...
  const awardCategoryColumn = psgcMode ? 2 : null; const pairingColumn = handicapMode ? (psgcMode ? 3 : 2) : 1; const holeStart = pairingColumn + 1; const lastColumn = holeStart + 17;
