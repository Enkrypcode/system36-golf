...
export function SimpleTournamentTool({ courses }: { courses: ScoringCourse[] }) {
  ...
  return <main className="simple-tool">
    ...
    <footer className="app-footer"><span>© 2026 Golf Scoring System. All rights reserved.</span><span>Designed &amp; Built by Fikri · AI-assisted</span></footer>
